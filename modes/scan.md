# Mode: scan — Find the Newest, Best-Fit Jobs (LinkedIn + Nigerian Boards + Remote)
...
| `/naija-jobs scan {role or field}` | All sources for that role/field (any field — "nursing", "civil engineer", "HR") |
...
🔥 Apply today (posted <24h, few applicants, good fit)
 1. Data Analyst — Moniepoint · Lagos · 2h ago · <25 applicants · fit 72
...
Remote, open to Nigeria
 5. Data Analyst — Andela · Africa/Europe · 20h ago · USD · Remotive
    ...

⚠ Be careful
 - Sales Executive — Bright Future Ventures · asks for a fee, Gmail address → skip
