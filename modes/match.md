...
1. 🔥 Data Analyst — Moniepoint · Lagos · 2h ago · <25 applicants
   Fit 4.5/5 — you've built Power BI dashboards (NYSC PPA) and use SQL daily; entry-level; Lagos ✓
   Watch out: asks for "must have completed NYSC" — you have ✓
   → Apply today. Lead with the attendance dashboard (300 users).

2. Data Analyst — Andela (remote, Africa/Europe) · 20h ago · USD
   Fit 4.0/5 — strong SQL/Python match; remote from Nigeria ✓; contractor via Deel
   Watch out: 4h overlap with CET — fine for WAT
   → Apply this week.

...

Stretch (worth it if you want to push)
 - Senior Data Engineer — Kuda: asks 5+ yrs, you have 1.5. Skip unless you have a referral.
